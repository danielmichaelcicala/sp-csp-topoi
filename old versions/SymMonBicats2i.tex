...
\begin{figure}[h]
	...
	\label{fig:2cells}
\end{figure}
This idea goes back to B\'enabou's landmark paper \cite{Be}, in what was one of the first examples of a bicategory. The bicategory $\bicspmap{D}$ constructed by B\'enabou consisted of 
